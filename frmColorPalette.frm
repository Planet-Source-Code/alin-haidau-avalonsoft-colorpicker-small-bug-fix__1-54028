...
Private Sub Form_MouseUp(Button As Integer, Shift As Integer, x As Single, y As Single)
  ...
  If IsMouseOnBut Then
    ...
    With m_cMenu
      ...
      .AddItem "&VB colors", , , iMain, , (m_lSelectedPallete = ccVB), , "mnuPalMenu_VB"
      .AddItem "2&56 colors", , , iMain, , (m_lSelectedPallete = cc256), , "mnuPalMenu_256"
      .AddItem "256 &gray shades", , , iMain, , (m_lSelectedPallete = cc256Gray), , "mnuPalMenu_256Gray"
      .AddItem "&Browser-safe colors", , , iMain, , (m_lSelectedPallete = ccSafe), , "mnuPalMenu_Safe"
      .AddItem "Netscape &Named Colors", , , iMain, , (m_lSelectedPallete = ccNamed), , "mnuPalMenu_Named"
      .AddItem "&Windows System Colors", , , iMain, , (m_lSelectedPallete = ccWin), , "mnuPalMenu_Win"
      .AddItem "-", , , iMain
      .AddItem "&Load color palette...", , , iMain, , , , "mnuPalMenu_Load"
...
Private Sub m_cMenu_Click(ItemNumber As Long)
  ...
  Select Case skey
    Case "mnuPalMenu_2"
      m_lColorCount = LoadPalette(App.Path & "\Palettes\2 Colors palette.pal", m_oClrNames)
      m_lSelectedPallete = cc2
    Case "mnuPalMenu_8"
      m_lColorCount = LoadPalette(App.Path & "\Palettes\8 Colors palette.pal", m_oClrNames)
      m_lSelectedPallete = cc8
    Case "mnuPalMenu_16"
      m_lSelectedPallete = cc16
      m_lColorCount = LoadPalette(App.Path & "\Palettes\16 Colors palette.pal", m_oClrNames)
    Case "mnuPalMenu_256"
      m_lSelectedPallete = cc256
      m_lColorCount = LoadPalette(App.Path & "\Palettes\256 Colors palette.pal", m_oClrNames)
    Case "mnuPalMenu_256Gray"
      m_lSelectedPallete = cc256Gray
      m_lColorCount = LoadPalette(App.Path & "\Palettes\256 Grays palette.pal", m_oClrNames)
    Case "mnuPalMenu_VB"
      m_lSelectedPallete = ccVB
      m_lColorCount = LoadPalette(App.Path & "\Palettes\VB palette.pal", m_oClrNames)
    Case "mnuPalMenu_Safe"
      m_lSelectedPallete = ccSafe
      m_lColorCount = LoadPalette(App.Path & "\Palettes\Browser safe palette.pal", m_oClrNames)
    Case "mnuPalMenu_Named"
      m_lSelectedPallete = ccNamed
      m_lColorCount = LoadPalette(App.Path & "\Palettes\Named colors palette.pal", m_oClrNames)
    Case "mnuPalMenu_Win"
      m_lSelectedPallete = ccWin
      m_lColorCount = LoadPalette(App.Path & "\Palettes\Windows System palette.pal", m_oClrNames)
    Case "mnuPalMenu_Load"
      Dim sFileName As String
      Dim cc As New cCommonDialog
      If cc.VBGetOpenFileName(sFileName, , , , , , "Palettes|*.pal;*.hpl", 1, App.Path & "\Palettes", "Selectie paleta de culori...", "pal", Me.hWnd) Then
